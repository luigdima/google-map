...
`,
  ...
  getAddress(){
    ...
    geocoder.geocode({'location': latlng}, (results,status) => {
      if (status === 'OK') {
        results[0].address_components.forEach((v,i,a) => {
          switch(v.types[0]){
            case "route":
              objetoGeo.address1 = v.short_name;
            break;
            case "street_number":
              objetoGeo.address1_number = v.short_name;
            break;
            case "locality":
              objetoGeo.city = v.short_name;
            break;
            case "administrative_area_level_2":
              objetoGeo.region = v.short_name;
            break;
            ...
            break;
            case "postal_code":
              objetoGeo.postcode = v.short_name;
            break;
          }
        });
